...
@Component({
  selector: 'app-motos-usadas',
  templateUrl: './motos-usadas.component.html',
  styleUrl: './motos-usadas.component.css'
})
export class MotosUsadasComponent {
  products: any[] = [];
  columns: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.motosService.getAllUsadas().pipe(takeUntil(this.destroy$)).subscribe((data: any[]) => {
      this.columns = [
        { field: 'id', header: 'ID' },
